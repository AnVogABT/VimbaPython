...
# cam_model = 'Mono8'  # 'Mono8'
cam_model = 'Bgr8'

"""a folder with this name will be created in the folder_path test_name = '2022-03-31 test22' path,
where the frames will be stored
"""
folder_path = r"C:\Users\a.vogiatzis\Desktop\2022-07-26 DC2 Fokker Park"
...
if cam_model == "Bgr8":
    ...
    folder_path = os.path.join(folder_path, 'colored')
elif cam_model == 'Mono8':
    timeout_ms = 150
    settings_file = r"C:\Users\a.vogiatzis\Desktop\2022-07-26 DC2 Fokker Park\mono_camera_settings.xml"
    folder_path = os.path.join(folder_path, 'mono')
...
with Vimba.get_instance() as vimba:
    ...
    with cams[0] as cam:
        ...
        for frame in cam.get_frame_generator(limit=limit, timeout_ms=timeout_ms):
            frame.convert_pixel_format(getattr(PixelFormat,cam_model))
